...
// TODO: Replace these with actual Firebase project configuration from the Firebase console
// The user will need to provide these or set them up in .env.local
